...
if (isset($_SESSION['idestudiante'])) {
    $vUsuario = $_SESSION['idestudiante'];
    $row = consultarEstudiante($link, $vUsuario);
} else {
    ...
    <nav class="navbar is-transparent">
        <div class="navbar-brand">
            <a class="navbar-item" href="#">
                <img src="src/estudiante.jpg" alt="Logo de Clase" width="40" height="40">
            </a>
            ...
            <div class="navbar-start">
                ...
                <div class="navbar-item has-dropdown is-hoverable">
                    ...
                    <div class="navbar-dropdown is-boxed">
                        <a class="navbar-item" href="ProgESTUDIANTE.php">
                            Programación 2
                        </a>
            ...
            <div class="column is-one-quarter">
                ...
                <aside class="menu">
                    ...
                    <ul class="menu-list">
                        ...
                        <li> <a href="info.php"> información del estudiante</a></li>
                    </ul>
                    <p class="menu-label">
                        <i class="far fa-window-maximize"></i> TO DO LIST – LISTA DE TAREAS
                    </p>
                    <ul class="menu-list">
                        <li> <a href="ProgESTUDIANTE.php">Programación 2 </a> </li>
