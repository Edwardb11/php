...
<div class="column is-half">
    ...
    <div class="block">
        ...
        <h2 class="subtitle">Ciclos Repetitivos - For</h2>
    </div>
    <!-- Contenido -->
    <div class="block">
        ...
        <div class="block">
            <article class="message">
                ...
                <div class="message-body">
                    ...
                    <div class="field is-grouped">
                        <p class="control">
                            <button class="button is-link" type="cancel" onclick="javascript:window.location='ejemplo09.php';">Completar otro formulario </button>
                        </p>
                    </div>
                </div>
            </article>
