...
<div class="column is-half">
    ...
    <!-- Titulos -->
    <div class="block">
        <h1 class="title">Unidad 02: Ejercicio 6</h1>
        <h2 class="subtitle">Usando el ciclo for realizar un programa que imprima en una tabla los
            valores impares que existan entre un rango de datos previamente ingresados por el teclado.</h2>
    </div>
    <!-- Contenido -->
    <div class="block">
    ...
    <div class="block">
        <article class="message">
            ...
            <div class="message-body">
                ...
                <div class="field is-grouped">
                    <p class="control">
                        <button class="button is-link" type="cancel" onclick="javascript:window.location='ejercicio6.php';">Completar otro formulario </button>
                    </p>
                </div>
            </div>
        </article>
