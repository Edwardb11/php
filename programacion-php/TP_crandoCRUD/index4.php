...
$resultado = MostrarCliente($link); //resultado es igual a lo que me devuelva esa funcion
?>
...
<div class="column is-half">
    ...
    <div class="block">
        ...
        <h2 class="subtitle">TP - Cliente</h2>
    </div>
    ...
    <div class="block">
        <div class="columns">
            <div class="column is-4">
                <form action="cliente.php?opciones=INS" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="field">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a class="button is-info" data-toggle="tooltip" data-placement="top" title="Editar"
                                        name="editar"
                                        href="index4Editar.php?opciones=UDT&id=<?php echo $row['codcliente'] ?>"> <i
                                            class="
                                        fas fa-edit"></i> </a> </td>
                                <td> <a class="button is-danger" data-toggle="tooltip" data-placement="top"
                                        title="Anular" name="anular"
                                        href="cliente.php?opciones=DLT&id=<?php echo $row['codcliente'] ?>"> <i
