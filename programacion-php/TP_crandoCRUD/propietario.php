    ...
    switch ($opcion) {
        case 'INS':
            if (isset($_POST['guardarDatos'])) {
                ...
                $query = " 
                INSERT INTO `propietario`(`nombre`, `direccion`, `telefeno`, `fecha_nacimiento`, `experiencia`, `estado`) VALUES ('$descripcion', '$direccion', '$telefono', '$fecha', '$experiencia', '$estado')";
            }
        ...
        case 'DLT':
            ...
            $query = "UPDATE `propietario` SET `estado` = 'I' WHERE `codpropietario` = '$id'"; //para actualizar
        ...
        case 'UDT':
            ...
            $query = "UPDATE `propietario` SET `nombre` = '$descripcion', `direccion` = '$direccion', `telefeno` = '$telefono', `fecha_nacimiento`='$fecha',`experiencia` = '$experiencia',`estado` = '$estado' WHERE `codpropietario` = '$id'"; //para actualizar
