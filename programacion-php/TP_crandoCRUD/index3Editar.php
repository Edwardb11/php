...
if (!empty($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $row = ConsultarTiposPropietario($link, $id); //resultado es igual a lo que me devuelva esa funcion
...
<div class="column is-half">
    ...
    <div class="block">
        ...
        <h2 class="subtitle">Base de datos - Propietario - Editar registros</h2>
    </div>
    ...
    <div class="block">
        <div class="columns">
            <div class="column is-12">
                <form action="propietario.php?opciones=UDT" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    <input type="hidden" name="id" id="id" value="<?php echo $row['codpropietario'] ?>">
                    ...
                    <div class="field is-grouped">
                        ...
                        <p class="control">
                            <a class="button is-light" href="index3.php">Regresar</a>
                        </p>
                    </div>
                </form>
            </div>
