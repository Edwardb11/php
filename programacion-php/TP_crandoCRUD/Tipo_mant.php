    ...
    switch ($opcion) {
        case 'INS':
            if (isset($_POST['guardarDatos'])) {
                ...
                $query = " 
                INSERT INTO `tipo_mantenimiento`(`descripcion`, `comentario`, `estado`) VALUES ('$descripcion', '$comentario', '$estado')";
            }
        ...
        case 'DLT':
            ...
            $query = "UPDATE `tipo_mantenimiento` SET `estado` = 'I' WHERE `codtipo_mant` = '$id'"; //para actualizar
        ...
        case 'UDT':
            ...
            $query = "UPDATE `tipo_mantenimiento` SET `descripcion` = '$descripcion', `comentario` = '$comentario', `estado` = '$estado' WHERE `codtipo_mant` = '$id' "; //para actualizar
